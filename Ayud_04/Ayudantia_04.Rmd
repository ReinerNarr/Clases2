...
MAPA_hc <- st_as_sf(mapa[codigo_region == params$reg,]) # nos permite extraer los datos de pobreza por comuna
mapa_hc <- geojson_json(mapa_hc[mapa_hc$codigo_region == params$reg,]) # aquí lo transformamos en clase geojson
mapa_hc <- jsonlite::fromJSON(mapa_hc, simplifyVector = FALSE) # aqui lo transformamos en lista, donde contiene datos de geometría de comunas
